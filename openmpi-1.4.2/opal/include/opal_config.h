...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-g -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS=' ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/home/robertorp/packages/openmpi-1.4.2 --with-mpi=open_mpi --disable-aio"
...
#define OPAL_PACKAGE_STRING "Open MPI root@asterisk Distribution"

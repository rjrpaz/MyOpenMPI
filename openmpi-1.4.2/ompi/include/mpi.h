...
/*
 * Modificaciones para RAW Socket
 */
#define MPI_ERR_SOCKET_RAW 100
//OMPI_DECLSPEC struct my_list_node {int rank[2]; unsigned char addr[6];};
#define ETH_MTU 1500

/*
OMPI_DECLSPEC struct my_list_node {
*/
...
struct my_list_node {
    ...
    /* MAC Address del Nodo */
    unsigned char addr[6];

    /* Argumentos de MPI_My_Send */
...
typedef struct my_list_node my_sr_node;
...
OMPI_DECLSPEC  int MPI_Myinit(int *argc, char ***argv);
OMPI_DECLSPEC  int MPI_Myfinalize();
...
OMPI_DECLSPEC  int MPI_Myrecv(void *buf, int count, MPI_Datatype datatype, int source, 
                            int tag, MPI_Comm comm, MPI_Status *status);
...
OMPI_DECLSPEC  int MPI_Send(void *buf, int count, MPI_Datatype datatype, int dest, 
                            int tag, MPI_Comm comm);
OMPI_DECLSPEC  int MPI_Mysend(void *buf, int count, MPI_Datatype datatype, int dest, 
                            int tag, MPI_Comm comm);
...
OMPI_DECLSPEC  int PMPI_Myinit(int *argc, char ***argv);
OMPI_DECLSPEC  int PMPI_Myfinalize();
...
OMPI_DECLSPEC  int PMPI_Recv(void *buf, int count, MPI_Datatype datatype, int source, 
                             int tag, MPI_Comm comm, MPI_Status *status);
OMPI_DECLSPEC  int PMPI_Myrecv(void *buf, int count, MPI_Datatype datatype, int source, 
                             int tag, MPI_Comm comm, MPI_Status *status);
...
OMPI_DECLSPEC  int PMPI_Send(void *buf, int count, MPI_Datatype datatype, int dest, 
                             int tag, MPI_Comm comm);
OMPI_DECLSPEC  int PMPI_Mysend(void *buf, int count, MPI_Datatype datatype, int dest, 
                             int tag, MPI_Comm comm);
